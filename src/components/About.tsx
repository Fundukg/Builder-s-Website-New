      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
        ...
        <div>
          ...
          <div className="space-y-4 text-neutral-700 leading-relaxed text-lg">
            ...
            <p>
              Мы создаем конструкции, устойчивые к влаге и гниению, с самого начала. Таким образом, мы гарантируем, что
              ваш дом будет служить долгие десятилетия без проблем. Наша цель — максимально продлить срок его
