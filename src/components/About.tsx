        ...
        <div>
          ...
          <div className="space-y-4 text-neutral-700 leading-relaxed text-lg">
            ...
            <p>
              ...
              исторических бревенчатых построек. Мы понимали, что сохранение этих прекрасных зданий требует специальных
              знаний и технологий.
            </p>
            <p>
              Сегодня мы с гордостью предлагаем комплексные строительные услуги: от строительства новых бревенчатых и
              каркасных домов до обслуживания и реставрации существующих. Каждый проект отражает нашу преданность
              качеству, внимание к деталям и уважение к своему делу
            </p>
